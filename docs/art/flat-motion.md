...
the fourteenth, also built on the vocabulary rather than ported, and
Paper Planes on the same day, the fifteenth, also built on it from its first
line. (Word Trail
has no row of its own in the table below yet; its motion is recorded in
CLAUDE.md and in its own spec's section 11.) This page is the table a new or
